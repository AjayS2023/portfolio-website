    ...
    return (
        <div class="about-container">
            ...
            <div class="content">
                ...
                <p>
                    As an aspiring fullstack developer, I have experience with using HTML, CSS, and JavaScript
                    to create powerful, responsive websites.
                </p>
                <p>
                    Some of the technologies, frameworks, and stacks I have used are:
                </p>
                <ul>
